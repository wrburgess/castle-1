...
Default coding hook, useful with any programming language." (when (and (executable-find ispell-program-name) prelude-flyspell) (flyspell-prog-mode)) (when prelude-guru (guru-mode 1)) (when prelude-whitespace (whitespace-mode 1)) (prelude-local-comment-auto-fill) (prelude-add-watchwords) (add-hook (quote before-save-hook) (quote whitespace-cleanup) nil t))
...
;;;***

;;;### (autoloads nil nil ("prelude-programming-pkg.el") (20746 40560
;;;;;;  386769))
